        ...
        <div class="col-lg-8 col-md-8 col-11">
            <div class="row mt-2 shadow-lg bg-white align-items-center" style="border-radius: 2vh;">
                <div class="col-lg-5 col-md-5 col-12 px-5 pt-2 pb-0 mb-0 text-center">
                    <img style="width: 120px;" src="{{ asset('assets/logo_iaknpky_footer.png')}} " alt="">
                    <p class="fs-5 mt-2 mb-0 pb-0 fw-bold">REKAN</p>
                    <p class="fs-6 fw-bold">Perekaman Kegiatan <br> Harian dan Bulanan <br> Laporan Kinerja Bulanan Pegawai </p>
                </div>
